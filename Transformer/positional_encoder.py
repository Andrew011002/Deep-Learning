...
class PositionalEncoder(nn.Module):
    ...
    def __init__(self, d_model, seq_len, dropout=0.1) -> None:
        ...
        # pos shape: (seq_len, 1) dim: (d_model, )
        ...
        # reshape: (batch_size, seq_len, d_model) -> register encodings w/o grad
...
if __name__ == '__main__':
    ...
    pos_encoder = PositionalEncoder(d_model, seq_len, dropout=0.1)
